...
class ResetPasswordBloc extends Bloc<ResetPasswordEvent, ResetPasswordState> {
  ...
  void _onResetPassword(
    ...
    if (!Utils.isEmail(event.email.trim())) {
      emit(const ResetPasswordFailed(errorMsg: "Enter a valid Email Address!"));
      return;
    }
    ...
    if (event.password.length < 8) {
      emit(
          const ResetPasswordFailed(errorMsg: "Password Atleast 8 character!"));
      return;
    }
